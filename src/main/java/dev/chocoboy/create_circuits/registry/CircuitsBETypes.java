...
import dev.chocoboy.create_circuits.content.blocks.memory.latch.RSLatchBE;
...
public final class CircuitsBETypes {
    ...
    public static final BlockEntityEntry<RSLatchBE> RS_LATCH = REGISTRATE
        .blockEntity("rs_latch", RSLatchBE::new)
        .validBlocks(CircuitsBlocks.RS_LATCH)
        .register();
